...
function Particle(x, y, type) {
    this.radius = 1.1;
    this.randomRadius = utils.randomInt(radVal, radVal + 3);
    ...
    this.update = function (heading) {
        ...
        if (this.radius < this.randomRadius && this.dying === false) {
            this.radius += durVal;
        } else {
            this.dying = true;
        }
        ...
        if (type === "rect") {
            ...
            context.fillStyle = this.color;
            context.beginPath();
            context.fillRect(this.x, this.y, this.randomRadius, this.randomRadius);
            context.closePath();
            context.fill();
            context.restore();
        }
